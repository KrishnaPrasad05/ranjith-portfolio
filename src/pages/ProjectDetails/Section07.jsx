  ...
  <p className="text-muted">
    My aim was to pick the best performing design variation based on facts rather than gut feeling.
      ...
      <div>
        ...
        <h6 className="fw-bold">Design B – Center Aligned CTA</h6>
        <ul className="dot-list mb-3">
        ...
        <h6 className="fw-bold mt-5">Stakeholder Review Process</h6>
        <ul className="dot-list mb-3">
      ...
      <div>
        <h6 className="fw-bold">Final Decision Approach</h6>
  ...
  <div className="col-12 col-lg-8 d-flex">
    <div className="w-100 d-flex flex-column">
      ...
      <div className="flex-grow-1 d-flex flex-column">
        <h6 className="mb-2"><b>Design A (35%) </b>– The background slightly distracts and the content focus is not as strong as B.</h6>
      ...
      <div className="flex-grow-1 d-flex flex-column mt-3">
        <h6 className="mb-2"><b>Preferred Design: B (65%) </b>– It is clearer, more balanced, and makes the main message and CTA easier to notice quickly.</h6>
        <div className="image-wrapper flex-grow-1">
